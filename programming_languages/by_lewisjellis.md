>![](http://www.easyicon.net/api/resize_png_new.php?id=1174989&size=16)[LewisJEllis/awesome-lua](https://github.com/LewisJEllis/awesome-lua)
...
- Third-party modules
  - [lua-resty-http](httpps://github.com/pintsized/lua-resty-http) - Lua HTTP client driver, built on the cosocket API.
- Frameworks & tools
